<?php
#lets admin view all reservations
...
echo "<tr><td colspan='11'><button type='button' id='addRes' class='btn btn-success btn-block'><span class='glyphicon glyphicon-plus'></span> &nbsp; Add A Reservation</button></td></tr>";
echo "</table>";
